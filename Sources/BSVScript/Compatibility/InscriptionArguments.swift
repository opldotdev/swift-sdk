...
public struct InscriptionArguments: Hashable, Sendable {
    public let lockingScript: Script
    public let data: [UInt8]
    public let contentType: String
    public let enrichedArguments: EnrichedInscriptionArguments?

    public init(
        lockingScript: Script,
        data: [UInt8],
        contentType: String,
        enrichedArguments: EnrichedInscriptionArguments? = nil
    ) {
...
public struct EnrichedInscriptionArguments: Hashable, Sendable {
...
/// Go SDK spelling retained as a source-compatible shorthand.
public typealias InscriptionArgs = InscriptionArguments

/// Go SDK spelling retained as a source-compatible shorthand.
public typealias EnrichedInscriptionArgs = EnrichedInscriptionArguments
