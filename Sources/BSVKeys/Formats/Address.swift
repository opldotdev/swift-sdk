...
/// A Base58Check pay-to-public-key-hash (P2PKH) Bitcoin address.
public struct Address: Hashable, Sendable, CustomStringConvertible {
    ...
    /// Parses a P2PKH address with a strict 21-byte payload limit.
    ...
    /// The canonical Base58Check P2PKH encoding.
